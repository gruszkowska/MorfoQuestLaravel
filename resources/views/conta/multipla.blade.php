                            ...
                            <div class="w-full h-full">
                                <div class="h-full col-span-6 p-2 my-auto flex flex-col place-items-center items-center">
                                    <div class="w-full">
                                        ...
                                        @endcomponent
                                        <br><br>
                                        <form class="w-full" action="{{ route('multiplaForm') }}" method="post">
                                            @csrf
                                            <div class="w-4/5 mx-auto">
                                                ...
                                                <div class="col-span-6">
                                                    <label class="p-1" for="pergunta">Pergunta
                                                ...
                                                <div class="grid grid-cols-12 gap-2 my-2">
                                                    <div class="col-span-6">
                                                        <label class="p-1" for="resposta_a">A)
                                                            <textarea class="w-full focus:border-black rounded-md p-2 my-2"
                                                    ...
                                                    <div class="col-span-6">
                                                        <label class="p-1" for="resposta_b">B)
                                                            <textarea class="w-full focus:border-black rounded-md p-2 my-2"
                                                    ...
                                                    <div class="col-span-6">
                                                        <label class="p-1" for="resposta_c">C)
                                                            <textarea class="w-full focus:border-black rounded-md p-2 my-2"
                                                                type="mensage" name="resposta_c" id="resposta_c" rows="3"
                                                                required></textarea>
                                                        </label>
                                                    </div>
                                                    <div class="col-span-6">
                                                        <label class="p-1" for="resposta_d">D)
                                                            <textarea class="w-full focus:border-black rounded-md p-2 my-2"
                                                                type="mensage" name="resposta_d" id="resposta_d" rows="3"
                                                                required></textarea>
                                                        </label>
                                                    </div>
                                                </div>
